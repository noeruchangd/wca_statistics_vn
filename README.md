...
- [Average number of competitions of listed delegates at Vietnamese competitions by number of delegates](avg_comps_number_of_delegates)
...
- [Average results submission time by Vietnamese delegates](avg_results_submission_time)
- [Average results submission time in the current year by Vietnamese delegates](avg_results_submission_time_in_the_current_year)
- [Best first average](best_first_average)
- [Best first single](best_first_single)
- [Best medal collection by person](best_medal_collection_by_person)
...
- [Biggest rounds in Vietnam](biggest_rounds)
- [Competed in most provinces in Vietnam](competed_in_most_provinces)
- [Competitions count by week](competitions_count_by_week)
- [Competitions per year by person](competitions_per_year_by_person)
- [Competitions with the least number of no-shows in Vietnam](least_no_shows)
- [Complete competition winners](complete_competition_winners)
- [Delegated competitions per year](delegated_competition_per_year)
- [Delegated to attended competition ratio in the current year (Vietnam)](delegated_to_attended_competitions_ratio_in_current_year)
- [Fewest competitors contest](fewest_competitors_contest)
- [Kinch rankings of Vietnamese competitors](kinch_rankings)
- [Longest competitions in Vietnam](longest_competitions)
- [Longest competitions path](longest_competitions_path)
- [Longest standing records](longest_standing_records)
- [Longest streak of competitions in Vietnam](longest_streak_of_competitions_in_own_country)
...
- [Megaminx results compared to 3x3 (Vietnam)](minx_to_333)
- [Most 4th places](most_4th_places)
- [Most attended competitions in a single month](most_attended_competitions_in_single_month)
- [Most attended competitions in a single month (unique competitor)](most_attended_competitions_in_single_month_unique)
...
- [Most common delegate teams in Vietnam](most_common_delegates_team)
...
- [Sum of national rankings (average)](sum_of_ranks_average)
- [Sum of national rankings (single)](sum_of_ranks_single)
- [Vietnamese Championship podiums by person](vietnamese_championship_podiums_by_person)
- [Vietnamese Championship records](vietnamese_championship_records)
- [Vietnamese competitors with most competitions in the current year](vietnamese_competitors_with_most_competitions_in_current_year)
...
This information is based on competition results owned and maintained by the World Cube Assocation, published at [https://worldcubeassociation.org](https://worldcubeassociation.org) as of September 02, 2026.
