...
class VietnameseChampionshipRecords < GroupedStatistic
  def initialize
    @title = "Vietnamese Championship records"
    ...
    @table_header = { "Event" => :left, "Result" => :right, "Person" => :left, "Competition" => :left }
  end
